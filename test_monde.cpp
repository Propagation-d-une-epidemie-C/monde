...
std::vector<int> mon_comptage = ma_propagation.comptage(ma_position, mon_monde(ma_position));
double rayon_contamination = ma_propagation.get_rayon_contamination();
double prob_infection = ma_propagation.get_prob_infection();
ma_propagation.propa(ma_position, mon_monde(ma_position), mon_comptage, rayon_contamination, prob_infection);
